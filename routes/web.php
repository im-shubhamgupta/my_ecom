...
// Route::middleware(['auth:backend_user', 'role:admin'])->group(function () {

// });

Route::group(['middleware'=>'admin_auth'],function(){
    Route::middleware(['session.role:user,admin,manager'])->group(function () {
        Route::get('admin/dashboard',[AdminController::class,'dashboard']);
    });    
    Route::middleware(['session.role:admin,manager'])->group(function () {
    ...
    Route::middleware(['session.role:admin'])->group(function () {
    ...
    Route::middleware(['session.role:admin,manager,user'])->group(function () {
