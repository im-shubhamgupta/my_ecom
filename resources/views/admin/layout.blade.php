...
<head>
    ...
    <script src=""></script>
    <link rel="stylesheet" media="screen, print" href="{{asset('admin_assets/vendor/datatable/datatables.min.css')}}">
    {{-- <link rel="stylesheet" media="screen, print" href="{{'https://cdn.datatables.net/2.0.5/css/dataTables.dataTables.min.css'}}"> --}}
    {{-- <link rel="stylesheet" media="screen, print" href="{{'https://cdn.datatables.net/2.0.7/css/dataTables.bootstrap4.min.css'}}"> --}}
...
<div class="page-wrapper">
    ...
    {{-- <script src="{{asset('admin_assets/vendor/datatable/datatables.min.js')}}"></script> --}}
